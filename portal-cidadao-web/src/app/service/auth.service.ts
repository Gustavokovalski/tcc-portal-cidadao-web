...
export class AuthService extends BaseService {
    private currentUserSubject: BehaviorSubject<IUsuarioModel> = {} as BehaviorSubject<IUsuarioModel>;
    public currentUser: Observable<IUsuarioModel> = {} as Observable<IUsuarioModel>;
